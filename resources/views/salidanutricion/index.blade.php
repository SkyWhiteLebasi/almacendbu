...
@section('content_header')
    ...
    @can('salidanutricion.import-excel')
        <a href="{{ url('salidanutricion/import-excel') }}" type="button"class="btn btn-pastel2"> <i class="fas fa-file-excel"></i> Importar
            excel</a>
    @endcan
    @can('salidanutricion.pdf_nutricion')
        <a href="{{ url('salidanutricion/pdf_nutricion') }}" type="button" class="btn btn-pastel3"><i class="fas fa-file-pdf"></i>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($nutricion as $salida)
                                                ...
                                                {{-- |       @endif --}}
                                                        ...
                                                        <form action="{{ url('/salidanutricion/' . $salida->id) }}" id="form-eliminar" class="d-inline"
                                                            method="POST">
                                                            @csrf
                                                            {{method_field('DELETE')}}
